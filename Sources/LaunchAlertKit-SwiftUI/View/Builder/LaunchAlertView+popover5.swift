...
public struct LaunchAlertView_Popover5: LaunchAlertViewProtocol {
...
public class Popover5LaunchAlertViewConfig: LaunchAlertViewConfig {
    public override init(lang: CKLanguage) {
        ...
        closeButtonTitleColor = Color(r: 255, g: 199, b: 0)
