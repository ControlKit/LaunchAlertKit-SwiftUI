...
public struct LaunchAlertView_Popover4: LaunchAlertViewProtocol {
...
public class Popover4LaunchAlertViewConfig: LaunchAlertViewConfig {
    public override init(lang: CKLanguage) {
        ...
        buttonBackColor = Color(r: 147, g: 56, b: 237)
        closeButtonBorderColor = Color(r: 147, g: 56, b: 237)
        closeButtonTitleColor = Color(r: 147, g: 56, b: 237)
